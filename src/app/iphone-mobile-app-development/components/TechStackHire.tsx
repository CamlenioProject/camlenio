...
import { LazyMotion, domMax, m, useScroll } from "framer-motion";
...
const technologies = [
  {
    name: "Swift & SwiftUI",
    category: "Languages",
    description: "Native iOS development for maximum performance and seamless Apple ecosystem integration.",
    icon: Code2,
  ...
  },
  {
    name: "UIKit & Xcode",
    category: "Framework",
    description: "Industry-standard tools for building robust, pixel-perfect iOS interfaces.",
    icon: Smartphone,
  ...
  },
  {
    ...
    description: "Seamless integration with third-party services, backends, and cloud platforms.",
    icon: Server,
  ...
  },
  {
    name: "Firebase & AWS",
    category: "Backend",
    description: "Scalable serverless backends with real-time databases and cloud functions.",
    icon: Cloud,
  ...
  },
  {
    ...
    category: "Storage",
    description: "Apple-native local and cloud data persistence with encryption.",
    icon: Database,
          ...
          <div className="mb-16">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
              <div className="max-w-2xl">
                ...
                >
                  Our iOS developers leverage Apple&apos;s cutting-edge frameworks and modern tools to build robust and scalable iPhone apps that stand the test of time.
                </m.p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div className="space-y-8 order-2 lg:order-1">
                  ...
                  <div className="text-lg text-gray-300 leading-relaxed space-y-4">
                    <p>
                      Looking to hire iPhone app developers in India? Camlenio offers dedicated iOS development teams and flexible engagement models to match your project requirements and budget.
                    </p>
                    <p>
                      Whether you&apos;re building a new iPhone app or upgrading an existing one, we deliver reliable iOS solutions using Swift, SwiftUI, and the latest Apple technologies.
                    </p>
                  </div>
                ...
                <div className="relative order-1 lg:order-2 min-h-[450px] flex items-center justify-center">
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold shrink-0">AP</div>
                      <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <span className="px-2 py-1 bg-gray-50 rounded text-[10px] text-gray-500 font-bold">Firebase</span>
                    </div>
                  </m.div>
                  ...
                  >
                    ...
                    <div className="flex gap-2">
                      ...
                      <span className="px-2 py-1 bg-gray-50 rounded text-[10px] text-gray-500 font-bold">Sketch</span>
                    </div>
                  </m.div>

                  {/* Card 3: Main iOS Dev (Center) */}
                  <m.div
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        <div className="font-bold text-gray-900 text-lg">Senior iOS Dev</div>
                    ...
                    <div className="space-y-3 mb-6">
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-bold text-gray-900">Swift, SwiftUI</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-500">Location</span>
                        <span className="font-bold text-gray-900">Jaipur, IN</span>
                      </div>
                    </div>
