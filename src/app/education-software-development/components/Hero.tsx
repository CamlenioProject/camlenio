...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[90vh] pt-32 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden bg-transparent flex flex-col justify-center">
      ...
      {/* Background decorative glowing light circles */}
      ...
      <div className="max-w-7xl mx-auto relative z-10 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center text-left">
        ...
        <div className="lg:col-span-7 flex flex-col items-start space-y-6">
          ...
          >
            Camlenio is a top school management software development company in Jaipur, providing user-friendly solutions for modern educational institutions. From admission management to online learning platforms, we create education systems that simplify administration, improve communication, and improve student engagement. If you require a school ERP or cloud-based management systems, our experts offer customized solutions that are created to your institution's needs.
          </motion.p>
        ...
        <div className="lg:col-span-5 relative w-full flex justify-center lg:justify-end mt-8 lg:mt-0">
          ...
          >
            <div className="relative w-full h-full rounded-[2.5rem] overflow-hidden">
              <Image
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuDKqNXc9Z-Q7sZA4oI5ivrTVet53dGxA0N5L30d3tQLiMOFQhyAFomTNbGiXwMBkh21rXcY3ykszL-BN1ahST1Ge5L-sq_CdSgiBsiPX_BtDtstVkjuBiXssPdtq5PPE4gh9IyvdK9IsL9e1KkE4g_w_1o5Tt3tAi7Bd6zKddZZdlb5NVU8a28RoO2WkkYalkL95AXAjmccfYPTnrIUD9plXjTvHfgojm7Fvha8oCF8UxJcRwN4cUYh4q51qgpVSx4DmsTx5uxHt1k"
                alt="Modern school management system ERP dashboard"
                fill
