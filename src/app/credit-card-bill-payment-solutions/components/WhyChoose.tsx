          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            >
              ...
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed text-justify font-sans font-medium">
                Camenio is a top fintech software Development Company in Jaipur, delivering creative payment technology solutions. Our experienced development team focuses on security and scalability to help businesses develop in the competitive fintech industry. We provide customized solutions, dedicated support, and feature-ready technology that allows businesses to deliver reliable Credit Card Bill payment services with confidence.
              </p>
            </motion.div>
          ...
          <div className="lg:col-span-6 relative h-[450px] sm:h-[550px] flex items-center justify-center">
            ...
            <div className="relative w-full max-w-[420px] h-[340px] rounded-[3rem] bg-gradient-to-r from-orange-400 via-red-500 to-amber-500 overflow-hidden shadow-2xl p-8 flex flex-col justify-between items-start text-left">
              ...
              <div className="relative z-10 text-white space-y-2 max-w-[200px]">
                ...
                <h3 className="text-lg font-black leading-snug">Empower Your Fintech Platform Today!</h3>
                <p className="text-[9px] opacity-75 leading-relaxed">Secure payment pathways, instant bank settlements, and fully custom dashboard designs.</p>
              </div>
              ...
              >
                <div className="flex justify-between items-start">
                  <span className="text-[7px] tracking-widest opacity-80 uppercase">Secure Link</span>
                  <div className="w-4 h-4 rounded-full bg-white/10" />
                </div>
                <div className="space-y-2">
                  <div className="text-[8px] tracking-widest">**** **** 4598</div>
                  <div>
                    <div className="text-[5px] uppercase opacity-60">Network</div>
                    <span className="text-[7px] font-bold">RUPAY GATEWAY</span>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex justify-between items-start">
                  <span className="text-[7px] tracking-widest opacity-80 uppercase">BBPS Standard</span>
                  <div className="w-4 h-4 rounded-full bg-orange-500" />
                </div>
                <div className="space-y-2">
                  <div className="text-[8px] tracking-widest">**** **** 9845</div>
                  <div>
                    <div className="text-[5px] uppercase opacity-60">System</div>
                    <span className="text-[7px] font-bold">BILL SETTLEMENT</span>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex justify-between items-start">
                  <span className="text-[7px] tracking-widest opacity-80 uppercase">Fintech Core</span>
                  <div className="w-4 h-4 bg-white/20 rounded flex items-center justify-center text-[5px] font-bold">Visa</div>
                </div>
                <div className="space-y-2">
                  <div className="text-[8px] tracking-widest">**** **** 3280</div>
                  <div>
                    <div className="text-[5px] uppercase opacity-60">Client</div>
                    <span className="text-[7px] font-bold">JAIPUR FINANCE</span>
                  </div>
                </div>
              </motion.div>
