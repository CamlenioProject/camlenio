...
import { ArrowRight, Users, QrCode, ShieldCheck, Layers, Sparkles } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto relative z-10 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center text-left">
        ...
        <div className="lg:col-span-7 flex flex-col items-start space-y-6">
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-gray-900 leading-[1.1] tracking-tight relative animate-fade-in"
          >
            Your Reliable <br />
            <span
          ...
          >
            Looking for a trusted reseller software development company in Jaipur? Camlenio offers scalable and secure reseller management solutions customized for fintech, travel, recharge, SaaS, and distribution businesses. From advanced reseller panels to complete white label platforms, we help your businesses automate solution management and grow revenue efficiently.
          </motion.p>
          ...
          >
            ...
            >
              <span>Get Reseller Solution</span>
        ...
        <div className="lg:col-span-5 relative w-full flex justify-center lg:justify-end mt-12 lg:mt-0">
          ...
          <FloatingBadge className="-top-6 -left-6 md:-left-12" delay={0.4} yOffset={-12}>
            ...
            <div className="text-left">
              <p className="text-xs font-bold text-gray-800">Reseller Panel</p>
              <span className="text-[10px] text-gray-500">B2B Workflow Automation</span>
            </div>
          </FloatingBadge>
          ...
          <FloatingBadge className="top-1/3 -right-6 md:-right-10" delay={0.6} yOffset={-15}>
            ...
            <div className="text-left">
              <p className="text-xs font-bold text-gray-800">White Label</p>
              <span className="text-[10px] text-gray-500">Launch Branded Platforms</span>
            </div>
          </FloatingBadge>
          ...
          <FloatingBadge className="-bottom-6 left-6 md:-left-4" delay={0.8} yOffset={-10}>
            ...
            <div className="text-left">
              <p className="text-xs font-bold text-gray-800">Multi-Reseller</p>
              <span className="text-[10px] text-gray-500">Expand Distribution Networks</span>
            </div>
          </FloatingBadge>
          ...
          >
            ...
            <div className="relative w-full h-full rounded-[2.2rem] overflow-hidden">
              <Image
                ...
                alt="Modern SaaS Reseller Dashboard Mockup"
                fill
