    ...
    <section className="relative min-h-[90vh] pt-32 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden bg-transparent flex flex-col justify-center">
      ...
      <div className="max-w-7xl mx-auto relative z-10 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center text-left">
        ...
        <div className="lg:col-span-7 flex flex-col items-start space-y-6">
          ...
          >
            Grow your Fintech Business with{" "}
            <span
          ...
          <motion.p
            ...
            className="text-sm sm:text-base text-gray-600 font-medium font-sans leading-relaxed max-w-xl text-left"
          >
            The UPI Cash Point services help businesses offer convenient digital payments and cash withdrawals. With reliable software, fintech companies can manage transactions on a simple, secure platform. Camlenio developed scalable UPI Cash Point Software designed to help businesses manage their operations efficiently.
          </motion.p>
          ...
          >
            ...
            >
              <span>Build Your UPI Cash Point</span>
        ...
        <div className="lg:col-span-5 relative w-full flex justify-center lg:justify-end mt-12 lg:mt-0">
          ...
          >
            <div className="relative w-full h-full rounded-[2.2rem] overflow-hidden">
              <Image
                src="/assets/upi-cash-point/upi-hero-new.png"
