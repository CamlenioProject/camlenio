...
import { ShieldCheck, GitMerge, Activity, Headphones, ArrowRight } from "lucide-react";
...
const trustFactors = [
  {
    icon: ShieldCheck,
    title: "NPCI & UIDAI Security Compliance",
    desc: "Built with industry-grade data privacy standards, guaranteeing fully secure Aadhaar biometric authentication.",
  },
  {
    icon: GitMerge,
    title: "Custom Fintech API Integration",
    desc: "Robust, scalable API pathways configured for custom portal requirements and micro-ATMs.",
  },
  {
    icon: Activity,
    title: "High Transaction Uptime",
    desc: "Redundant banking integration pipes that prevent latency and minimize failed withdrawal cycles.",
  },
  {
    icon: Headphones,
    title: "Ongoing Technical Support",
    desc: "Dedicated post-deployment technical assistance, regular security patches, and upgrades from our expert teams.",
  },
];
        ...
        <div className="lg:col-span-5 space-y-8 text-left">
          <div className="space-y-4">
            ...
            <p className="text-sm sm:text-base text-gray-600 font-sans font-medium leading-relaxed">
              Camlenio stands out as a trusted AEPS Software Development Company in Jaipur with a strong focus on security and scalability. Our developer teams develop customized fintech solutions that align with your business objectives. We combine advanced technology with deep industry expertise to create high-performance platforms that guarantee seamless transactions and the best user experience.
            </p>
          </div>
