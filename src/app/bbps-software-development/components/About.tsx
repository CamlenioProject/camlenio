      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        <div className="bg-white/60 backdrop-blur-md rounded-[4rem_1.5rem_4rem_1.5rem] p-8 md:p-16 border border-orange-500/10 shadow-[0_20px_50px_rgba(249,115,22,0.04)] grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-left">
            <div className="space-y-4">
              <span className="text-xs sm:text-sm font-bold tracking-wider text-orange-500 uppercase font-sans">
                Advanced Bill Payment Solutions
              </span>
              <motion.h2
            ...
            >
              <p>
                Camlenio is a professional BBPS Software Company in India that businesses trust for creative and secure digital payment solutions. Our fintech software development company specializes in developing a high-performance BBPS Software for startups and enterprises. Our Bharat Bill Payment System Software supports electricity, gas, Credit card Bill Payment, water, and many more services through a single platform.
              </p>
              <p>
                We offer complete BBPS portal development with secure APIs, fast processing, user-friendly interfaces, and scalable architecture. Whether you need white label BBPS software, our experienced team offers customized solutions to your business requirements.
              </p>
            </motion.div>
          ...
          <div className="lg:col-span-5 relative group cursor-pointer w-full flex justify-center">
            ...
            >
              <Image
                src="/assets/BBPS/bbps-img1.webp"
                alt="Bharat Bill Payment System Development Workspace"
                fill
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md border border-orange-500/10 rounded-2xl p-4 z-20 flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-gray-800">NPCI Certified</p>
                  <p className="text-[10px] font-medium text-gray-500">Secure Bill Processing</p>
                </div>
              </div>
            </motion.div>
