...
export default function Testimonials() {
  ...
  return (
    <LazyMotion features={domMax}>
      <div className="bg-gradient-to-r from-indigo-50 via-orange-100 to-indigo-100 py-20">
            ...
            <div className="p-8 flex flex-col justify-center ">
              <div className="text-center mb-12">
                ...
                <p className="mt-2 text-gray-600 max-w-2xl mx-auto font-sans text-justify">
                  ...
                  that are both effective and future-ready. Our goal is to
                  create value and trust that last beyond the services we
                  provide.
                </p>
              </div>
            </div>
