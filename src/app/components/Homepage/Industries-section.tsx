...
import { industriesSectionData } from "@/config/homepage";
    ...
    <LazyMotion features={domMax}>
      <div className="relative py-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-8 md:px-16 relative text-left md:text-center">
          ...
          >
            {industriesSectionData.header.title}{" "}
            <span
          ...
          >
            {industriesSectionData.header.description}
          </m.p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-left">
            {industriesSectionData.cards.map((card, i) => (
              <m.div
                key={i}
                ...
                viewport={{ once: true }}
                className="rounded-4xl shadow-md overflow-hidden group bg-orange-50 transform-gpu"
