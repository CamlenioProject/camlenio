...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen  overflow-hidden py-20 lg:py-12">
      <div className="relative mx-auto max-w-7xl px-6 min-h-screen flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 sm:gap-8 w-full items-center">
          {/* LEFT CONTENT */}
          <motion.div
          ...
          >
            ...
            {/* badge */}
            <div className="inline-flex items-center gap-2 rounded-full bg-orange-100 px-4 py-1 text-xs font-medium text-orange-600 mb-5">
            ...
            <div className="mt-8">
              <Link
                href="/component/company/contact"
