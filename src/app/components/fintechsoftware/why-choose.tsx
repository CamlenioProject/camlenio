...
const FeatureCard = ({
  ...
  return (
    ...
    >
      ...
      {/* Card Content */}
      <div className="relative h-full bg-orange-100/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-orange-100/50 overflow-hidden">
          ...
          >
            ...
            >
              ...
              <span className="relative inline-block mt-1 sm:mt-2">
                <span className="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600">
                  Partner
                </span>
                <m.div
                  initial={{ scaleX: 0 }}
                  ...
                  className="absolute -bottom-0 left-0 right-0 h-2 bg-gradient-to-r from-orange-200 to-orange-300 opacity-40 origin-left"
                />
              </span>
            </m.h1>
