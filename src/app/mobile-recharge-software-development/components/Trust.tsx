...
const trustFactors = [
  {
    ...
    desc: "Years of experience in fintech software development with deep expertise in building secure recharge platforms.",
  },
  {
    icon: Settings,
    title: "Creativity & Innovation",
    desc: "Creative technology solutions that help businesses stand out in the competitive fintech landscape.",
  },
  {
    icon: Zap,
    title: "High-Performance Platforms",
    desc: "We develop high-performance fintech platforms that are secure and easy to manage for growing businesses.",
  },
  {
    icon: Headphones,
    title: "Customer Focused Approach",
    desc: "Our expertise understands the growing demand for recharge services and offers customised solutions that help businesses to expand faster.",
  },
];
        ...
        <div className="lg:col-span-5 space-y-8 text-left">
          <div className="space-y-4">
            ...
            <p className="text-sm sm:text-base text-gray-600 font-sans font-medium leading-relaxed">
              Camlenio stands out as a reliable fintech app development company in Jaipur because of our experience, creativity, and customer focused approach. We develop high-performance fintech platforms that are secure and easy to manage. Our expertise understands the growing demand for recharge services and offers customised solutions that help businesses to expand faster.
            </p>
          </div>
