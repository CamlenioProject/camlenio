...
import { MotionLayout } from "../realestatesoftware/components/MotionLayout";
import { RevealSection } from "../realestatesoftware/components/RevealSection"; // Import RevealSection here too for the middle text
