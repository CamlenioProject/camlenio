      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          >
            ...
            {/* Signature Heading */}
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 leading-[1.15] tracking-tight mb-8">
            ...
            <p className="text-sm md:text-base font-sans text-justify text-gray-500 leading-relaxed mb-10 max-w-xl">
