        ...
        <div className="bg-white/60 backdrop-blur-md rounded-[4rem_1.5rem_4rem_1.5rem] p-8 md:p-16 border border-orange-500/10 shadow-[0_20px_50px_rgba(249,115,22,0.04)] grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-left">
            <div className="space-y-4">
              ...
              >
                Empowering Digital Services with{" "}
                <span
            ...
            >
              <p>
                Camlenio stands out as a PAN Card Software Company in Jaipur, offering powerful, scalable solutions customized for fintech businesses. Our team extends beyond PAN solutions into BBPS software development, enabling businesses to manage bill payments, PAN Services, and customer onboarding on a single platform.
              </p>
              <p>
                As a top PAN Card Software Development Company, we integrate advanced features, such as PAN verification API, secure payment gateways, and real-time tracking systems. If you require NSDL PAN card software or UTI PAN Card Software, our customized platforms guarantee an easy solution and compliance. With a strong presence as a PAN card software company in India, we help businesses digitize operations and increase efficiency.
              </p>
            </motion.div>
            ...
            >
              <Button
                ...
                className="shadow-md"
              >
                <span>Request PAN Software Demo</span>
          ...
          <div className="lg:col-span-5 relative group cursor-pointer w-full flex justify-center">
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md border border-orange-500/10 rounded-2xl p-4 z-20 flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-gray-800">NSDL & UTI Certified</p>
                  <p className="text-[10px] font-medium text-gray-500">Secure PAN Processing</p>
                </div>
              </div>
            </motion.div>
