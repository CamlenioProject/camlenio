...
import { Globe, Smartphone, Settings, FileCheck } from "lucide-react";
...
const services = [
  {
    icon: Globe,
    title: "PAN Card Portal Development",
    desc: "Complete PAN card portal development with secure architecture for online applications, status tracking, and document uploads.",
  },
  {
    icon: Smartphone,
    title: "PAN Card Mobile App Development",
    desc: "Android and web-based applications with secure functionality for PAN card services and real-time status updates.",
  },
  {
    icon: Settings,
    title: "PAN Card API Integration",
    desc: "Seamless PAN verification API integration with NSDL and UTI platforms for fast and reliable processing.",
  },
  {
    icon: FileCheck,
    title: "Fintech Software Customization",
    desc: "Customized fintech software solutions supporting PAN services, correction requests, and complete document management.",
  },
];
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 gap-8">
          ...
          <div className="max-w-md text-left lg:text-right">
            <p className="text-gray-600 font-medium font-sans text-sm sm:text-base">
              Camlenio offers complete development and integration services for digital businesses. We include PAN card portal development, PAN card mobile app development, API Integration, and fintech software customization. We develop secure PAN card services software to support online applications, status tracking, document uploads, and correction requests. Businesses looking for software or UTI PAN card software can trust our expertise for powerful platforms.
            </p>
          </div>
        </div>
